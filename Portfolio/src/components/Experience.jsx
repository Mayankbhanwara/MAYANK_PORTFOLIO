  ...
  const experiences = [
    {
      ...
      location: "Jaipur",
      description: "Focused on core frontend development and UI enhancement for ed-tech tools.",
    ...
    {
      company: "RCAT",
      fullName: "RCAT (Red Hat Linux-Based Company)",
      role: "RHCSA Training",
      duration: "Sep 2025 - Oct 2025",
      location: "Jaipur",
      description: "Training focused on Red Hat Enterprise Linux (RHEL), Linux CLI, Bash Scripting, Shell Commands, Git (basic), and File System Management.",
      technologies: ["RHEL", "Linux CLI", "Bash Scripting", "Git"],
              ...
              <div className="relative z-10">
                ...
                <div className="mb-4 sm:mb-5">
                  <h3 className="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white font-cinzel tracking-tight drop-shadow-sm leading-tight transition-colors duration-500">
                    {exp.link ? (
                      <a href={exp.link} target="_blank" rel="noopener noreferrer" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors" title="View Certificate">
                        {exp.company}
                      </a>
                    ) : (
                      exp.company
                  ...
                  <div className="text-[11px] sm:text-[13px] text-gray-400 dark:text-gray-500 font-medium tracking-wide mb-2 sm:mb-2 uppercase transition-colors duration-500">
                    {exp.link ? (
                      <a href={exp.link} target="_blank" rel="noopener noreferrer" className="hover:text-indigo-500 dark:hover:text-indigo-400 transition-colors inline-flex items-center gap-1" title="View Certificate">
                        {exp.fullName}
